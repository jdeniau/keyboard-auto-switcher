...
namespace KeyboardAutoSwitcher
{
    ...
    /// </summary>
    public class KeyboardLayoutConfig(string cultureName, int layoutId, string displayName)
    {
        public string CultureName { get; } = cultureName;
        public int LayoutId { get; } = layoutId;
    ...
    public static class KeyboardLayouts
    {
        ...
        {
            return layoutId == UsDvorak.LayoutId ? UsDvorak : layoutId == FrenchStandard.LayoutId ? FrenchStandard : null;
        }
        ...
        public static KeyboardLayoutConfig? GetByLanguageId(int langId)
        {
            ...
            return langId == UsDvorak.GetLanguageId() ? UsDvorak : langId == FrenchStandard.GetLanguageId() ? FrenchStandard : null;
        }
    }
}
