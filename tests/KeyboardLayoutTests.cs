...
namespace KeyboardAutoSwitcher.Tests
{
    ...
    public class KeyboardLayoutTests
    {
        ...
        {
            // Assert
            _ = KeyboardLayouts.UsDvorak.ShouldNotBeNull();
        ...
        {
            // Assert
            _ = KeyboardLayouts.FrenchStandard.ShouldNotBeNull();
        ...
        {
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByCultureName("en-US");
        ...
        {
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByCultureName("fr-FR");
        ...
        public void GetByLayoutId_WithDvorakLayoutId_ShouldReturnUsDvorak()
        {
            ...
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByLayoutId(dvorakLayoutId);
        ...
        public void GetByLayoutId_WithFrenchLayoutId_ShouldReturnFrenchStandard()
        {
            ...
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByLayoutId(frenchLayoutId);
        ...
        public void GetByLanguageId_WithEnglishUSLangId_ShouldReturnUsDvorak()
        {
            ...
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByLanguageId(englishUSLangId);
        ...
        public void GetByLanguageId_WithFrenchLangId_ShouldReturnFrenchStandard()
        {
            ...
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByLanguageId(frenchLangId);
        ...
        {
            // Act
            KeyboardLayoutConfig? result = KeyboardLayouts.GetByLanguageId(langId);
        ...
        public void GetByCultureName_ShouldBeConsistentWithGetByLayoutId()
        {
            ...
            KeyboardLayoutConfig? byCulture = KeyboardLayouts.GetByCultureName("en-US");
            KeyboardLayoutConfig? byLayoutId = KeyboardLayouts.GetByLayoutId(byCulture!.LayoutId);
